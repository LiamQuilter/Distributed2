...
public class MapReduceFiles {
  static final int LINES_PER_THREAD = 5000;
  static final int WORDS_PER_REDUCE_THREAD = 500;
  ...
  public static void main(String[] args) {
    ...
    // APPROACH #3: Distributed MapReduce
    {
      ...
      int linesPerThread = LINES_PER_THREAD; // Example value, can be adjusted between 1000 and 10000
      ...
      for (Map.Entry<String, List<String>> entry : groupedEntries) {
        ...
        chunkSize++;
        if (chunkSize >= WORDS_PER_REDUCE_THREAD) { // Maximum chunk size
